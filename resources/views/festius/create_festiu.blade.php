...
<h2 class="m-2 w-100">Crear festiu</h2>
<a href="/cur/{{$cursid}}/festiu" class="btn btn-info m-2">Ves a tots els festius del curs</a>
<form action="/cur/{{$cursid}}/festiu" class="m-2" method='POST'>
    @csrf
    <div class="mb-3">
