...
<div class="d-flex flex-wrap m-2">
    ...
    <a href="/cur/{{$cur->id}}/festiu/create" class="btn btn-success m-2">Crea un nou festiu</a>
    <a href="/cur/{{$cur->id}}/trimestre/create" class="btn btn-success m-2">Crea un nou trimestre</a>
